- 全局搜索`${K8S_MASTER_IP}` 将其修改为自己的K8s-master机器对应的内网Ip

- 按序执行以下命令

```bash
kubectl apply -f kube-monitoring-ns.yaml
...
```a
${K8S_MASTER_IP} alertmanager.monitoring.com
${K8S_MASTER_IP} prometheus.monitoring.com
${K8S_MASTER_IP} grafana.monitoring.com
```
